...
@AutoValue public abstract class CardDetails implements Parcelable {
  ...
  @SerializedName("cardholder_name") public abstract String cardholderName();

  @SerializedName("checkout_token") public abstract String checkoutToken();

  @SerializedName("cvv") public abstract String cvv();

  @SerializedName("expiration") public abstract String expiration();

  @SerializedName("number") public abstract String number();
